  ...
  return (
    ...
    >
      ...
      <div className='flex gap-2 mt-5'>
        <button onClick={() => dispatch({ type: productActionTypes.ADD_TO_CART, payload: product })} className='bg-indigo-500 rounded-full py-1 px-2 flex-1 text-white text-bold'>
          Add to cart
        </button>
        <button
